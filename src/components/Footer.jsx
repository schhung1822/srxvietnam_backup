...
const srxLinks = [
  { href: "/about", label: "Về SRX" },
  { href: "/products", label: "Sản phẩm" },
  { href: "/key-srx", label: "Từ điển sản phẩm" },
  { href: "/follow-srx", label: "Theo dòng SRX" },
  { href: "/tin-tuc", label: "Tin tức" },
  { href: "/chu-de-khoa-hoc", label: "Chủ đề khoa học" },
...
const policyLinks = [
  ...
  { href: "/quy-dinh-thanh-toan", label: "Quy định thanh toán" },
...
const FooterAnimatedLink = ({ children, href }) => (
  <Link href={href} className="relative inline-flex max-w-full text-white/90 transition-colors duration-500">
...
const FooterLinkItem = ({ href, label }) => (
  <li className="group flex items-center text-[14px] text-white">
    ...
    <FooterAnimatedLink href={href}>{label}</FooterAnimatedLink>
  </li>
);
        ...
        <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-20">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="ml-2 flex items-center rounded-[50%] bg-black p-2">
